...
//			String filePath = config.getFileinfo().getDownloadPath() + fileName;
...
//		try {
//			// 上传文件路径
//			String filePath = config.getFileinfo().getUploadPath();
//			// 上传并返回新文件名称
...
//			throws Exception {
//		// 本地资源路径
//		String localPath = config.getFileinfo().getProfile();
//		// 数据库资源地址
